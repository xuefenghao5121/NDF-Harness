...
> **sot:** true（对本仓 Agent **流程纪律**）；**false**（对 the product **检索/缓存/SLA 产品行为**）

本目录是仓库对 NDF 的 **process profile**：探索/晋升双轨、POC 边界、主题装订、
规范卫生 ADR、审核工具。它**不是** the product 产品行为契约树。
...
| 流程纪律 | [`process.md`](process.md)（[[CHR-008]]、[[BEH-018]]…[[BEH-020]]、[[BEH-025]]、[[META-006]]、[[META-007]]、[[META-009]]…[[META-012]]、[[META-014]]、[[META-016]]…[[META-018]]；[[META-013]]/[[META-015]] deprecated） |
